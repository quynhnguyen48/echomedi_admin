...
export const getListConversationQueues = (pagination, filters) => {
  ...
  return axios.get(`/conversation-queues?populate[user][populate]=*&populate[second_person][populate]=*&filters[second_person][id][\$null]=true&${query}`)
}
...
export const getListConversationQueueByUser = (userId, pagination) => {
  ...
  return axios.get(`/conversation-queues?populate[user][populate]=*&populate[second_person][populate]=*&filters[second_person]=${userId}&${query}`)
}
