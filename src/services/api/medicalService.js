...
export const getListMedicalServices = (pagination, filters) => {
  const query = qs.stringify({
    filters,
    pagination,
    // sort: ["code:ASC"],
  })
  return axios.get(`/medical-services?populate=*&${query}`)
}
...
export const getMedicalServiceById = (id) => {
  ...
  return axios.get(`/medical-services/${id}?populate=*`)
}
...
export const createMedicalService = (data) => {
  return axios.post(`/medical-services`, {
    data,
  })
}
...
export const updateMedicalService = (id, data) => {
  return axios.put(`/medical-services/${id}`, {
    data,
  })
}
