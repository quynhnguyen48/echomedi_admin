...
import MentalTreatmentForm from "./components/MentalTreatmentForm"
  ...
  return (
    <Page title="Hồ sơ bệnh án">
      ...
      <div className="mt-4 rounded-t-2xl">
        {viewMode
          ? medicalRecordData && (
              <MentalTreatmentForm data={medicalRecordData} user={user} readonly={true} />
            )
          : medicalRecordData && <MentalTreatmentForm user={user} data={medicalRecordData} />}
      </div>
    </Page>
  )
}
